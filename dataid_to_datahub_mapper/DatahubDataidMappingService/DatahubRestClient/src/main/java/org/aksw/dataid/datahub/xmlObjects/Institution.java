...
public class Institution {
    ...
    private Repository.Literal institutionName;
    @JacksonXmlElementWrapper(namespace = namespace, localName = "institutionAdditionalName")
    private List<Repository.Literal> institutionAdditionalName;
    @JacksonXmlProperty(namespace = namespace, localName = "institutionCountry")
    private String institutionCountry;                                              //url
    @JacksonXmlElementWrapper(namespace = namespace, localName = "responsibilityType")
    ...
    public Repository.Literal getInstitutionName() {
        return institutionName;
    }

    public void setInstitutionName(Repository.Literal institutionName) {
        this.institutionName = institutionName;
    }

    public List<Repository.Literal> getInstitutionAdditionalName() {
        return institutionAdditionalName;
    }

    public void setInstitutionAdditionalName(List<Repository.Literal> institutionAdditionalName) {
