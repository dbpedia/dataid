package org.aksw.dataid.datahub.jsonutils;
 ...
 */
public class TtlParser implements RDFParser, RDFHandler {
    ...
    public synchronized RDFDataset parse(Object input) throws JsonLdError {
        if (String.class.isAssignableFrom(input.getClass())) {
            ...
            throw new JsonLdError(JsonLdError.Error.INVALID_INPUT, "RdfXmlParser expected string input.");
        }
    }
